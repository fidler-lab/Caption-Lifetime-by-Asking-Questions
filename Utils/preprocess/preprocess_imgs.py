...
/images is (N,3,256,256) uint8 array of raw image annotation in RGB format
...
if __name__ == "__main__":
  ...
  parser.add_argument('--output_dir', default='annotation', help='output file')
  ...
  parser.add_argument('--model_root', default='Utils/preprocess/checkpoint', type=str, help='model root')
